...
import 'package:big_cart/features/view/home/BottomNavigationBar/Screens/cart/cartScreenEmpty.dart';
import 'package:big_cart/features/view/home/BottomNavigationBar/Screens/cart/widget/productItemCart.dart';
                          ...
                          return ProductItemCart(
                            onTap: () async {
                              ...
                              String? currentCartItemID =
                                  preferences.getString('currentCartItemID');
                              if (currentCartItemID != null) {
                                BlocProvider.of<CartCubit>(context)
                                    .RemoveFromCart(
                                        currentCartItemID: currentCartItemID);
                              }
                            },
